...
```
## Output:
<img width="257" height="98" alt="image" src="https://github.com/user-attachments/assets/00f9e70d-fa36-40f6-a356-30b929e00055" />


## Result: 
Thus, the program is verified successfully.

# EXP NO:2 C PROGRAM FOR PASSING STRUCTURES AS FUNCTION ARGUMENTS AND RETURNING A STRUCTURE FROM A FUNCTION ## Aim:
...
```
## Output:
<img width="152" height="172" alt="image" src="https://github.com/user-attachments/assets/0f6db6da-5d61-41fd-a844-8970b881b993" />
...
```
## Output:
<img width="265" height="86" alt="image" src="https://github.com/user-attachments/assets/a2700bda-b9c2-4773-b039-abb32930c7a8" />
...
```
## Output:
<img width="259" height="116" alt="image" src="https://github.com/user-attachments/assets/6add133d-06a9-4e31-b5a5-eb3e50bb654b" />
...
```
## Output:
<img width="254" height="166" alt="image" src="https://github.com/user-attachments/assets/601de7f8-44ff-407e-9878-01ad824128f7" />
